...
type SyncServiceClient interface {
	...
	CancelOrders(ctx context.Context, in *ReqCancelOrder, opts ...grpc.CallOption) (*Resp, error)
	GetOrders(ctx context.Context, in *ReqOrders, opts ...grpc.CallOption) (*RespOrders, error)
	WaitOrdersDone(ctx context.Context, in *ReqOrders, opts ...grpc.CallOption) (*Resp, error)
...
func (c *syncServiceClient) CancelOrders(ctx context.Context, in *ReqCancelOrder, opts ...grpc.CallOption) (*Resp, error) {
	out := new(Resp)
	err := grpc.Invoke(ctx, "/exsync.SyncService/CancelOrders", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) WaitOrdersDone(ctx context.Context, in *ReqOrders, opts ...grpc.CallOption) (*Resp, error) {
	out := new(Resp)
	err := grpc.Invoke(ctx, "/exsync.SyncService/WaitOrdersDone", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SyncServiceServer interface {
	...
	CancelOrders(context.Context, *ReqCancelOrder) (*Resp, error)
	GetOrders(context.Context, *ReqOrders) (*RespOrders, error)
	WaitOrdersDone(context.Context, *ReqOrders) (*Resp, error)
...
func _SyncService_CancelOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqCancelOrder)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServiceServer).CancelOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exsync.SyncService/CancelOrders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).CancelOrders(ctx, req.(*ReqCancelOrder))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SyncService_WaitOrdersDone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqOrders)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServiceServer).WaitOrdersDone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exsync.SyncService/WaitOrdersDone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).WaitOrdersDone(ctx, req.(*ReqOrders))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SyncService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SyncService_CancelOrders_Handler,
		},
		{
		...
		{
			MethodName: "WaitOrdersDone",
			Handler:    _SyncService_WaitOrdersDone_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
