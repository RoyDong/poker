...
type SyncServiceClient interface {
	...
	WaitOrders(ctx context.Context, in *ReqOrders, opts ...grpc.CallOption) (*Resp, error)
...
func (c *syncServiceClient) WaitOrders(ctx context.Context, in *ReqOrders, opts ...grpc.CallOption) (*Resp, error) {
	out := new(Resp)
	err := grpc.Invoke(ctx, "/exsync.SyncService/WaitOrders", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SyncServiceServer interface {
	...
	WaitOrders(context.Context, *ReqOrders) (*Resp, error)
...
func _SyncService_WaitOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqOrders)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServiceServer).WaitOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exsync.SyncService/WaitOrders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).WaitOrders(ctx, req.(*ReqOrders))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SyncService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitOrders",
			Handler:    _SyncService_WaitOrders_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
