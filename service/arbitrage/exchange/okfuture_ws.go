...
type OKFutureWS struct {
    *gmvc.Event
    ...
    currentOrders map[int64]arbitrage.Order
...
func NewOKFutureWS(contractType string) *OKFutureWS {
    ...
    ok.lastTicker = arbitrage.Ticker{}
    ok.lastTrade = Trade{}
    ...
    ok.currentOrders = make(map[int64]arbitrage.Order, 4)
...
func (ok *OKFutureWS) LastTicker() arbitrage.Ticker {
